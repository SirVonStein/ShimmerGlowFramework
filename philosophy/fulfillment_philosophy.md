...
## Title
ShimmerGlow Fulfillment Philosophy: From Anti-Dopamine to Pro-Aliveness
...
- **Rerouting-Pattern Detection**: Monitors for and prevents:
...
- **Interaction Patterns**:
  - Taps/swipes may reinforces agency ("You chose this")
...
1. **Active Protagonist vs Passive Patient**: Users aren't fixing problems, they honor them by authoring their own adventures
...
- Every feature has simple opt-out as prominent as opt-in
...
2. **Animation Principles**:
   - Organic flow, dynamic if mechanical
...
3. **Transparency Always**: Explain the psychology/philosophy behind each mechanic if user requested
